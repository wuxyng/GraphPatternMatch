...
public class TwigListD_bup_bas {
	...
	public TwigListD_bup_bas(TreeQuery query, ArrayList<ArrayList<GraphNode>> invLsts, BFLIndex bfl) {
	...
	public QueryEvalStat run() {
		...
		System.out.println("Time on TwigListD_bup_bas:" + matm + "sec.");
		tt.Start();
