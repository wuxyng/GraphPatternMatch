 ...
 * @author xiaoying
 */
public class TwigListD_sim_plusplus {
	...
	public TwigListD_sim_plusplus(TreeQuery query, ArrayList<ArrayList<GraphNode>> invLsts, BFLIndex bfl) {
	...
	public TwigListD_sim_plusplus(TreeQuery query, ArrayList<ArrayList<GraphNode>> invLsts,
	...
	public QueryEvalStat run() {
		...
		System.out.println("Time on TwigListD_sim_plusplus:" + matm + "sec.");
		tt.Start();
