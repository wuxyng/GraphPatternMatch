 ...
 * @author xiaoying
 */
public class TwigListD_sim_flt {
	...
	public TwigListD_sim_flt(TreeQuery query, ArrayList<ArrayList<GraphNode>> invLsts, BFLIndex bfl) {
	...
	public QueryEvalStat run(double flttm) {
		...
		System.out.println("Time on TwigListD_sim_flt:" + matm + "sec.");
		tt.Start();
		...
		calAnsGraphSize();
		QueryEvalStat stat = new QueryEvalStat(matm, entm, flttm, totSolns, sizeOfAnsGraph);
