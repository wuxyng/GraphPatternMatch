 ...
 */
public class TwigListD_bup_flt {
	...
	public TwigListD_bup_flt(TreeQuery query, ArrayList<ArrayList<GraphNode>> invLsts, BFLIndex bfl) {
	...
	public QueryEvalStat run(double flttm) {
		...
		System.out.println("Time on TwigListD_bup_flt:" + matm + "sec.");
		tt.Start();
